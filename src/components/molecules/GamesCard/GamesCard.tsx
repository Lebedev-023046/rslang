...
const GamesCard: React.FC<GamesCardProps> = ({ type, fromTextBook }) => {
  switch (type) {
    case 'audio':
      return (
        <div className='games__card games__card_audio'>
          ...
          <Link className='nav__link' to={fromTextBook ? '/AudioChallenge1' : '/AudioChallenge'}>
            <Button
              type='primary'
              text='Play now'
              onClick={() => {}}
    ...
    case 'sprint':
      return (
        <div className='games__card games__card_sprint'>
          ...
          <Link className='nav__link' to={fromTextBook ? '/Sprint1' : '/Sprint'}>
            <Button
              type='primary'
              text='Play now'
              onClick={() => {}}
